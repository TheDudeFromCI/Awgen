...
public class MeshLoader implements FileLoader
{
	...
	@Override
	public MeshResource loadFile(ResourceManager resourceManager, ResourceFile resourceFile)
	{
		try
		{
			// Load the scene file
			AIScene scene = Assimp.aiImportFile(resourceManager.getFile(resourceFile).toString(),
