...
public class GLFWWindow implements Window
{
    ...
    public void buildWindow()
    {
        ...
        synchronized (_lock)
        {
            ...
            Log.trace("Creating GLFW callbacks.");
            {
                ...
                GLFW.glfwSetKeyCallback(_windowId, (long window, int key,
                ...
                GLFW.glfwSetCharModsCallback(_windowId,
                        (long window, int key, int mods) ->
                        {
                            if (_window != null)
                                _window.addEvent(() ->
                                {
    ...
    public void disposeWindow()
    {
        ...
        {
            Log.warn(
                    "Tried to dispose window, but window is not currently open.");
            return;
        }
    ...
    {
        if (cursorEnabled)
            GLFW.glfwSetInputMode(_windowId, GLFW.GLFW_CURSOR,
