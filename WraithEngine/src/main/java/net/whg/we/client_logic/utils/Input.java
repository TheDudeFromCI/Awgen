...
public class Input
{
    ...
    public static void addTypedKey(int key, int modifiers, int extraKey)
    {
        ...
        k.key = (char) key;
        Log.tracef("Typed key %d, with modifiers %d, key type: %d.", key,
                modifiers, extraKey);
    ...
    /**
     * This should be called once at the end of frame. Updates key and mouse
     * delta states.
     */
    ...
    /**
     * Changes the location of the mouse. This should only be called by the a
     * window listener.
     *
     * @param mouseX
