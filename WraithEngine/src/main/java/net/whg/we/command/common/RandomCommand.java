...
public class RandomCommand implements CommandHandler
{
	...
	public String getHelpText()
	{
		...
		sb.append("random\n");
		sb.append("  Returns a random number between 0 (inclusive) and 1 (exclusive)\n");
		sb.append("random <max>\n");
		sb.append("  Returns a random number between 0 (inclusive) and max (exclusive)\n");
		sb.append("random <min> <max>\n");
		sb.append("  Returns a random number between min (inclusive) and max (exclusive)\n");
