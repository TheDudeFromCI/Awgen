...
import net.whg.we.server_logic.command.DynamicVariableArgument;
import net.whg.we.server_logic.command.StringArgument;
import net.whg.we.server_logic.command.VariableArgument;
