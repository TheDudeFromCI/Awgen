        ...
        try
        {
...

            {
                ResourceManager resourceManager =
                        _gameLoop.getResourceManager();
                ResourceFetcher fetch =
                        new ResourceFetcher(resourceManager, graphics);
                ...
                /*
                 * ModelResource terrain = (ModelResource)
                 * resourceManager.loadResource(plugin, "models/terrain.model");
                 ...
                 * model.getLocation() .setRotation(new
                ...
                _scene.getUIStack()
                        .addComponent(new Terminal(_gameLoop, fetch));
            }
