...
public interface PacketType
{
     ...
     * prefixes the data of the packet. This string is encoded into UTF-8, and
     * may not exceed 255 bytes in length.
     */
    String getTypePath();

    /**
     * Encodes a data map into a byte array, which can be later decoded back
     * into the same datamap on the server or client. This is called on a
     * private thread.
     *
     * @param bytes
     ...
     * @param length
     *                       - The number of bytes in the buffer which currently
    ...
    /**
     * This is called on the main thread during a physics update after a packet
     * is recieved and decoded. References to this map should not be stored as
     * this packet information is placed back into a pool after this packet is
     * processed.
     *
     * @param packet
