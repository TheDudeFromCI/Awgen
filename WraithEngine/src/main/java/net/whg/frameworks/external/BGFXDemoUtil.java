...
import static org.lwjgl.bgfx.BGFX.BGFX_RENDERER_TYPE_DIRECT3D9;
...
final class BGFXDemoUtil
{
	...
	static short loadShader(String name) throws IOException
	{
		...
		String resourcePath = "/res/shaders/";
		...
		switch (renderer) {
			...
			default:
				throw new IOException(
						"No demo shaders supported for " + bgfx_get_renderer_name(renderer) + " renderer");
		}
	...
	static short loadShader(char[] shaderCodeGLSL, char[] shaderCodeD3D9, char[] shaderCodeD3D11, char[] shaderCodeMtl)
			throws IOException
	{
		char[] sc;
