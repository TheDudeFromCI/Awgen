...
import net.whg.we.server_logic.command.CommandVariable;
...
{
    private void validateCommand(CommandExecution exe, String name,
            String[] args, CommandVariable out)
    {
    ...
    public void parse6()
    {
        ...
        CommandSet set =
                CommandParser.parse(null, sender, "$out = clear; time -f ss");
    ...
    public void parse7()
    {
        ...
        CommandSet set =
                CommandParser.parse(null, sender, "$out = get1; $out = get2");
    ...
    public void parse8()
    {
        ...
        CommandSet set =
                CommandParser.parse(null, sender, "a123 (abc -1; def -2)");
    ...
    public void parse10()
    {
        ...
        CommandSet set =
                CommandParser.parse(null, sender, "list $[hello world]");
        ...
        validateCommand(cmds.get(0), "list", args("$[hello world]"),
                vars.get(0));
    }
}
