...
import net.whg.frameworks.command.CommandParseException;
import net.whg.frameworks.command.Token;
import net.whg.frameworks.command.TokenTemplate;
import net.whg.frameworks.command.Tokenizer;
...
public class TokenizerTest
{
    ...
    public void nestedCommand()
    {
        ...
        validateToken(token.nextToken(), "123 \"456\" $789",
                TokenTemplate.NESTED_COMMAND);
    ...
    public void dynamicVariable()
    {
        ...
        validateToken(token.nextToken(), "clear",
                TokenTemplate.DYNAMIC_VARIABLE);
        Assert.assertFalse(token.hasNextToken());
    }
    ...
    public void nestedDynamicVariable()
    {
        ...
        validateToken(token.nextToken(), "clear (time -f ss)",
                TokenTemplate.DYNAMIC_VARIABLE);
        Assert.assertFalse(token.hasNextToken());
    }
