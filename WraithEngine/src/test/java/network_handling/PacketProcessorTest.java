...
public class PacketProcessorTest
{
    ...
    public void addPackets()
    {
        ...
        PacketProcessor processor = new PacketProcessor(pool, null);
    ...
    public void handlePackets()
    {
        ...
        Mockito.verify(packet).process(null);
    ...
    {
        /*
         * This method is empty in the class and is only there for the listener
         * to work. But for some reason, the coverage thing marks it as uncalled
         * code, despite being empty. So I'm just leaving this here for an extra
         * line of test coverage. Shrug.
         */

        new PacketProcessor(new PacketPool(), null).onPacketSent(null);
    }
}
