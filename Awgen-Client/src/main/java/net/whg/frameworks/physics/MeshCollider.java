...
public class MeshCollider implements Collider
{
	...
	public MeshCollider(VertexData vertexData, Transform3D location)
	{
	...
	public Collision collideRay(Vector3f p, Vector3f d, float dist)
	{
		...
		// This just lets us reused vectors instead of allocating new ones per
		// triangle
